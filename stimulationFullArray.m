...
params.minPause = 19.999; %seconds
...
%     stimulator.beginSequence();
%     stimulator.beginGroup();
%     stimulator.autoStim(1:2:95, 1);
%     stimulator.autoStim(2:2:96, 2);
%     stimulator.endGroup();
%     stimulator.endSequence();
...
cd(directories.recording)
save('trialInfo_FAProp2.mat','trialInfo','','stimElecs');
save('waveformParsIds_FAProp2.mat','waveTypes');
